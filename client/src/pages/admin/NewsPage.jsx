...
const blank = { slug: '', titleRu: '', titleKz: '', descriptionRu: '', descriptionKz: '', contentRu: '', contentKz: '', image: '', category: 'GENERAL', published: false, publishAt: '' };
