...
Публичные маршруты frontend: `/news` и `/news/:newsSlug`. Лента поддерживает главную публикацию, поиск и категории «Важное», «Объявления», «События» и «Новости». Управление публикациями находится в разделе `/admin/news` существующей админ-панели. Там можно создавать и редактировать материалы, выбирать категорию, загружать обложки JPG/PNG/WebP/GIF размером до 5 МБ, публиковать сразу или планировать выпуск на выбранные дату и время, снимать с публикации и удалять новости. Запланированная новость автоматически появляется в публичной ленте после наступления указанного времени.
...
Миграция `20260807090000_news` добавляет таблицу `News`, связь с автором, индексы публикации и новые действия аудита. Перед запуском обновлённого приложения примените миграции и при необходимости демонстрационные записи:
