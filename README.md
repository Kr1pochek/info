...
- 42 услуги КГД, 5 категорий, 6 пакетов обслуживания и поиск с debounce 300 мс;
...
Миграция создаёт таблицы, enum, связи и индексы. Seed идемпотентно создаёт первого `SUPER_ADMIN` из `server/.env`, 5 официальных категорий, 42 государственные услуги и 6 пакетов обслуживания из приложений к техническому заданию. Устаревшие демонстрационные карточки удаляются из рабочего каталога.
